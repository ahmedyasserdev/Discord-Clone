  ...
  return (
    <div>
      ...
      <button onClick = { () =>  onOpen("createServer")} className = "group flex items-center">
        <div className="mx-3 flex-center overflow-hidden bg-background dark:bg-neutral-700 group-hover:bg-emerald-500 h-[48px] w-[48px] rounded-[24px] group-hover:rounded-[16px] transition-all  ">
